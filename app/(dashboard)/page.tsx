      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-linear-to-b from-background to-muted/20">
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Platforma pro porovnávání výkonnosti algoritmů. Odevzdejte svá
            řešení a změřte síly s ostatními studenty.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border shadow-sm">
              ...
              <p className="text-muted-foreground">
                Vaše řešení jsou automaticky testována v izolovaném prostředí
                Docker kontejnerů.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border shadow-sm">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border shadow-sm">
              ...
              <p className="text-muted-foreground">
                Sledujte své umístění v reálném čase a soutěžte o nejlepší
                optimalizaci.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-muted-foreground">
              Vyberte si úlohu a začněte optimalizovat
            </p>
          </div>
            ...
            >
              ...
              <CardContent>
                <Button asChild className="w-full group-hover:bg-primary/90">
                  <Link
                    href={isLoggedIn ? `/benchmarks/${benchmark.id}` : "/login"}
                  >
                        ...
                        <div className="flex items-center gap-3">
                          <Avatar className="h-8 w-8 border-2 border-background">
                            <AvatarFallback
                              style={{
                                backgroundColor:
                                  result.submittedBy.colors.light,
                                color: "white",
                              }}
                            >
                              {result.submittedBy.nickname
                                .substring(0, 2)
                                .toUpperCase()}
                            </AvatarFallback>
                          </Avatar>
