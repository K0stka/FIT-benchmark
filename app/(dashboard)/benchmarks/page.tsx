...
const BenchmarksPage: NextPage = async () => {
	...
	return (
		<div className="container py-10">
			<div className="mb-8">
				<h1 className="text-3xl font-bold">Dostupné benchmarky</h1>
				<p className="text-muted-foreground mt-2">
					Vyberte benchmark a odešlete své řešení, abyste viděli, jak si vede.
				</p>
			</div>
				...
				{benchmarks.length === 0 ? (
					<Card>
						<CardContent className="py-10 text-center">
							<p className="text-muted-foreground">Zatím nejsou k dispozici žádné benchmarky. Zkontrolujte později!</p>
						</CardContent>
					</Card>
				) : (
						...
						<Card key={benchmark.id} className="hover:border-primary transition-colors">
							...
							<CardContent>
								<div className="mb-4 space-y-2 text-sm">
									<div>
										<span className="text-muted-foreground">Příkaz pro sestavení:</span>
